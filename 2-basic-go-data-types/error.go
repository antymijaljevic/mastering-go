...
func formattedError(a, b int) error {
	if a == 0 && b == 0 {
		return fmt.Errorf("a %d and b %d UserID: %d", a, b, os.Getuid()) // prints the user ID; linux "id" command
	}
	return nil
}
...
func main() {
	...
	i, err := strconv.Atoi("-123") // Atoi stands for ASCII to Int or string to int
	if err == nil {
